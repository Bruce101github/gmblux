export function tourRequestEmail({
  first_name,
  request_type,
  email,
  last_name,
...
<div class="container-1">
     <h1>${request_type} Request Confirmation</h1>
    <div class="container"> 
      <p>Hi <span class="highlight">${first_name}</span>,</p>
      <p>
        Thank you for your interest in this
        <a class="highlight" href="https://gmblux.com/listing/${property_id}">property</a>. 
        We’ve received your request to ${request_type} this  <a class="highlight" href="https://gmblux.com/listing/${property_id}">property</a> and our team is reviewing it.
      </p>
      <p>
        This process usually takes less than 24 hours, after which one of our representatives will 
reach out to confirm your preferred date and time.
      </p>
